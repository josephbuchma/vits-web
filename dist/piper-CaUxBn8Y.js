var ot = (() => {
  ...
  return typeof __filename < "u" && (Q = Q || __filename), function(Se = {}) {
    var d = Se, Fe, ee;
    d.ready = new Promise((e, a) => {
      Fe = e, ee = a;
    }), d.expectedDataFileDownloads || (d.expectedDataFileDownloads = 0), d.expectedDataFileDownloads++, function() {
      if (!(d.ENVIRONMENT_IS_PTHREAD || d.$ww)) {
        var e = function(a) {
          ...
          typeof d.locateFilePackage == "function" && !d.locateFile && (d.locateFile = d.locateFilePackage, C(
            "warning: you defined Module.locateFilePackage, that has been renamed to Module.locateFile (using your locateFilePackage for now)"
          ));
          var s = d.locateFile ? d.locateFile(r, "") : r, i = a.remote_package_size;
          function o(h, g, p, _) {
            ...
            E.open("GET", h, !0), E.responseType = "arraybuffer", E.onprogress = function(b) {
              ...
              if (b.total && (f = b.total), b.loaded) {
                E.addedTotal ? d.dataFileDownloads[S].loaded = b.loaded : (E.addedTotal = !0, d.dataFileDownloads || (d.dataFileDownloads = {}), d.dataFileDownloads[S] = { loaded: b.loaded, total: f });
                var c = 0, z = 0, D = 0;
                for (var x in d.dataFileDownloads) {
                  var R = d.dataFileDownloads[x];
                  c += R.total, z += R.loaded, D++;
                }
                c = Math.ceil(c * d.expectedDataFileDownloads / D), d.setStatus && d.setStatus(`Downloading data... (${z}/${c})`);
              } else d.dataFileDownloads || d.setStatus && d.setStatus("Downloading data...");
          ...
          var m = null, v = d.getPreloadedPackage ? d.getPreloadedPackage(s, i) : null;
          v || o(
            s,
            i,
            function(h) {
          ...
          function y() {
            ...
            d.FS_createPath("/", "espeak-ng-data", !0, !0), d.FS_createPath("/espeak-ng-data", "lang", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "aav", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "art", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "azc", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "bat", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "bnt", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "ccs", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "cel", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "cus", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "dra", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "esx", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "gmq", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "gmw", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "grk", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "inc", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "ine", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "ira", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "iro", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "itc", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "jpx", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "map", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "miz", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "myn", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "poz", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "roa", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "sai", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "sem", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "sit", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "tai", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "trk", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "urj", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "zle", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "zls", !0, !0), d.FS_createPath("/espeak-ng-data/lang", "zlw", !0, !0), d.FS_createPath("/espeak-ng-data", "mbrola_ph", !0, !0), d.FS_createPath("/espeak-ng-data", "voices", !0, !0), d.FS_createPath("/espeak-ng-data/voices", "!v", !0, !0), d.FS_createPath("/espeak-ng-data/voices", "mb", !0, !0);
            function g(b, S, f) {
            ...
            g.prototype = {
              requests: {},
              open: function(b, S) {
                this.name = S, this.requests[S] = this, d.addRunDependency(`fp ${this.name}`);
              },
              send: function() {
              },
              onload: function() {
              ...
              finish: function(b) {
                var S = this;
                d.FS_createDataFile(this.name, null, b, !0, !0, !0), d.removeRunDependency(`fp ${S.name}`), this.requests[this.name] = null;
              }
            };
            ...
            function E(b) {
              ...
              d.removeRunDependency("datafile_piper_phonemize.data");
            }
            d.addRunDependency("datafile_piper_phonemize.data"), d.preloadResults || (d.preloadResults = {}), d.preloadResults[t] = { fromCache: !1 }, v ? (E(v), v = null) : m = E;
          }
          d.calledRun ? y() : (d.preRun || (d.preRun = []), d.preRun.push(y));
        };
        e({
          files: [
    ...
    var Pe = Object.assign({}, d), ge = [], ae = "./this.program", te = (e, a) => {
      throw a;
    }, De = typeof window == "object", q = typeof importScripts == "function", ne = typeof process == "object" && typeof process.versions == "object" && typeof process.versions.node == "string", N = "";
    function Ze(e) {
      return d.locateFile ? d.locateFile(e, N) : N + e;
    }
    var G, $, re;
    if (ne) {
      ...
      }, !d.thisProgram && process.argv.length > 1 && (ae = process.argv[1].replace(/\\/g, "/")), ge = process.argv.slice(2), te = (e, a) => {
        throw process.exitCode = e, a;
      }, d.inspect = () => "[Emscripten Module object]";
    } else (De || q) && (q ? N = self.location.href : typeof document < "u" && document.currentScript && (N = document.currentScript.src), Q && (N = Q), N.indexOf("blob:") !== 0 ? N = N.substr(
      0,
    ...
    var ke = d.print || console.log.bind(console), C = d.printErr || console.error.bind(console);
    Object.assign(d, Pe), Pe = null, d.arguments && (ge = d.arguments), d.thisProgram && (ae = d.thisProgram), d.quit && (te = d.quit);
    var X;
    d.wasmBinary && (X = d.wasmBinary), typeof WebAssembly != "object" && L("no native wasm support detected");
    var Ae, Me = !1, se;
    function Qe(e, a) {
      e || L(a);
    }
    ...
    function ea() {
      var e = Ae.buffer;
      d.HEAP8 = T = new Int8Array(e), d.HEAP16 = V = new Int16Array(e), d.HEAPU8 = H = new Uint8Array(e), d.HEAPU16 = new Uint16Array(e), d.HEAP32 = k = new Int32Array(e), d.HEAPU32 = A = new Uint32Array(e), d.HEAPF32 = new Float32Array(e), d.HEAPF64 = new Float64Array(e);
    }
    var Re = [], ze = [], aa = [], Te = [];
    function ta() {
      if (d.preRun)
    ...
    function na() {
      !d.noFSInit && !n.init.initialized && n.init(), n.ignorePermissions = !1, de(ze);
    }
    function ra() {
      de(aa);
    }
    ...
    function ie(e) {
      U++, d.monitorRunDependencies && d.monitorRunDependencies(U);
    }
    function J(e) {
      if (U--, d.monitorRunDependencies && d.monitorRunDependencies(U), U == 0 && K) {
        var a = K;
        K = null, a();
      }
    }
    function L(e) {
      d.onAbort && d.onAbort(e), e = "Aborted(" + e + ")", C(e), Me = !0, se = 1, e += ". Build with -sASSERTIONS for more info.";
    ...
    function ma(e, a, t, r) {
      return !e && typeof WebAssembly.instantiateStreaming == "function" && !Ne(a) && !oe(a) && !ne && typeof fetch == "function" ? fetch(a, { credentials: "same-origin" }).then((s) => {
        ...
        return i.then(r, function(o) {
          return C(`wasm streaming compile failed: ${o}`), C("falling back to ArrayBuffer instantiation"), Ce(a, t, r);
        });
      }) : Ce(a, t, r);
    }
    function ca() {
      var e = { a: st };
      function a(r, s) {
        return j = r.exports, Ae = j.w, ea(), oa(j.x), J(), j;
      }
      ie();
      function t(r) {
        a(r.instance);
    ...
    d.noExitRuntime;
    var Oe = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0, Y = (e, a, t) => {
      ...
      for (var i = ""; a < s; ) {
        ...
        var l = e[a++] & 63;
        if ((o & 224) == 192) {
          i += String.fromCharCode((o & 31) << 6 | l);
          continue;
        }
        var m = e[a++] & 63;
        if ((o & 240) == 224 ? o = (o & 15) << 12 | l << 6 | m : o = (o & 7) << 18 | l << 12 | m << 6 | e[a++] & 63, o < 65536)
          i += String.fromCharCode(o);
        else {
          var v = o - 65536;
    ...
    var je = 0, ua = (e, a, t) => {
      ...
      relative: (e, a) => {
        ...
        for (var r = t(e.split("/")), s = t(a.split("/")), i = Math.min(r.length, s.length), o = i, l = 0; l < i; l++)
          if (r[l] !== s[l]) {
            o = l;
            break;
          }
        for (var m = [], l = o; l < r.length; l++)
          m.push("..");
    ...
    function le(e, a, t) {
      var r = _e(e) + 1, s = new Array(r), i = we(e, s, 0, s.length);
...
`));
      ...
      stream_ops: {
        read(e, a, t, r, s) {
          ...
          if (o > 8 && i.subarray)
            ...
            for (var l = 0; l < o; l++) a[t + l] = i[s + l];
          return o;
        },
        write(e, a, t, r, s, i) {
          if (!r) return 0;
          var o = e.node;
          if (o.timestamp = Date.now(), a.subarray && (!o.contents || o.contents.subarray)) {
            if (i)
          ...
          if (w.expandFileStorage(o, s + r), o.contents.subarray && a.subarray)
            o.contents.set(a.subarray(t, t + r), s);
          else
            for (var l = 0; l < r; l++)
              o.contents[s + l] = a[t + l];
        ...
        mmap(e, a, t, r, s) {
          if (!n.isFile(e.node.mode))
            throw new n.ErrnoError(43);
          var i, o, l = e.node.contents;
          if (!(s & 2) && l.buffer === T.buffer)
            o = !1, i = l.byteOffset;
          else {
            if ((t > 0 || t + a < l.length) && (l.subarray ? l = l.subarray(t, t + a) : l = Array.prototype.slice.call(l, t, t + a)), o = !0, i = Be(), !i)
    ...
    }, wa = (e, a, t, r, s, i) => n.createDataFile(e, a, t, r, s, i), ya = d.preloadPlugins || [], ba = (e, a, t, r) => {
      typeof Browser < "u" && Browser.init();
      var s = !1;
      return ya.forEach((i) => {
        s || i.canHandle(a) && (i.handle(e, a, t, r), s = !0);
      }), s;
    }, Ea = (e, a, t, r, s, i, o, l, m, v) => {
      var y = a ? O.resolve(P.join2(e, a)) : e;
      function h(g) {
        function p(_) {
          v && v(), l || wa(e, a, _, r, s, m), i && i(), J();
        }
        ba(g, y, p, () => {
          o && o(), J();
        }) || p(g);
      }
      ie(), typeof t == "string" ? _a(t, (g) => h(g), o) : h(t);
    }, Sa = (e) => {
      var a = {
        r: 0,
        "r+": 2,
      ...
      lookupPath(e, a = {}) {
        ...
        for (var r = e.split("/").filter((h) => !!h), s = n.root, i = "/", o = 0; o < r.length; o++) {
          var l = o === r.length - 1;
          if (l && a.parent)
            break;
          if (s = n.lookupNode(s, r[o]), i = P.join2(i, r[o]), n.isMountpoint(s) && (!l || l && a.follow_mount) && (s = s.mounted.root), !l || a.follow)
      ...
      rename(e, a) {
        var t = P.dirname(e), r = P.dirname(a), s = P.basename(e), i = P.basename(a), o, l, m;
        if (o = n.lookupPath(e, { parent: !0 }), l = o.node, o = n.lookupPath(a, { parent: !0 }), m = o.node, !l || !m) throw new n.ErrnoError(44);
        if (l.mount !== m.mount)
      ...
      open(e, a, t) {
        if (e === "")
          throw new n.ErrnoError(44);
        a = typeof a == "string" ? Sa(a) : a, t = typeof t > "u" ? 438 : t, a & 64 ? t = t & 4095 | 32768 : t = 0;
        var r;
        if (typeof e == "object")
          r = e;
        else {
        ...
        return l.stream_ops.open && l.stream_ops.open(l), d.logReadFiles && !(a & 1) && (n.readFiles || (n.readFiles = {}), e in n.readFiles || (n.readFiles[e] = 1)), l;
      },
      close(e) {
        if (n.isClosed(e))
          throw new n.ErrnoError(8);
      ...
      readFile(e, a = {}) {
        ...
        return n.read(r, o, 0, i, 0), a.encoding === "utf8" ? t = Y(o, 0) : a.encoding === "binary" && (t = o), n.close(r), t;
      },
      writeFile(e, a, t = {}) {
        t.flags = t.flags || 577;
        var r = n.open(e, t.flags, t.mode);
        if (typeof a == "string") {
          var s = new Uint8Array(_e(a) + 1), i = we(a, s, 0, s.length);
        ...
        n.mkdir("/proc/self/fd"), n.mount(
          {
            mount() {
              ...
              return a.node_ops = {
                lookup(t, r) {
                  var s = +r, i = n.getStreamChecked(s), o = {
                    parent: null,
      ...
      createStandardStreams() {
        d.stdin ? n.createDevice("/dev", "stdin", d.stdin) : n.symlink("/dev/tty", "/dev/stdin"), d.stdout ? n.createDevice("/dev", "stdout", null, d.stdout) : n.symlink("/dev/tty", "/dev/stdout"), d.stderr ? n.createDevice("/dev", "stderr", null, d.stderr) : n.symlink("/dev/tty1", "/dev/stderr"), n.open("/dev/stdin", 0), n.open("/dev/stdout", 1), n.open("/dev/stderr", 1);
      },
      ensureErrnoError() {
      ...
      init(e, a, t) {
        n.init.initialized = !0, n.ensureErrnoError(), d.stdin = e || d.stdin, d.stdout = a || d.stdout, d.stderr = t || d.stderr, n.createStandardStreams();
      },
      quit() {
      ...
      createFile(e, a, t, r, s) {
        var i = P.join2(typeof e == "string" ? e : n.getPath(e), a), o = ye(r, s);
        return n.create(i, o);
      },
      createDataFile(e, a, t, r, s, i) {
        var o = a;
        e && (e = typeof e == "string" ? e : n.getPath(e), o = a ? P.join2(e, a) : e);
        var l = ye(r, s), m = n.create(o, l);
        if (t) {
          if (typeof t == "string") {
      ...
      doStat(e, a, t) {
        ...
        return M = [
          ...
          Math.floor(o / 1e3) >>> 0,
          (u = Math.floor(o / 1e3), +Math.abs(u) >= 1 ? u > 0 ? +Math.floor(u / 4294967296) >>> 0 : ~~+Math.ceil((u - +(~~u >>> 0)) / 4294967296) >>> 0 : 0)
        ], k[t + 72 >> 2] = M[0], k[t + 76 >> 2] = M[1], A[t + 80 >> 2] = o % 1e3 * 1e3, M = [
          r.ino >>> 0,
    ...
    var qe = (e, a, t) => we(e, H, a, t);
    function Pa(e, a, t) {
      try {
        var r = F.getStreamFromFD(e);
        r.getdents || (r.getdents = n.readdir(r.path));
        for (var s = 280, i = 0, o = n.llseek(r, 0, 1), l = Math.floor(o / s); l < r.getdents.length && i + s <= t; ) {
        ...
        switch (a) {
          ...
          case 21508: {
            ...
            if (r.tty.ops.ioctl_tcsets) {
              for (var i = F.getp(), l = k[i >> 2], m = k[i + 4 >> 2], v = k[i + 8 >> 2], y = k[i + 12 >> 2], h = [], o = 0; o < 32; o++)
                h.push(T[i + o + 17 >> 0]);
    ...
    var Ta = !0, Na = () => Ta, xa = () => {
      L("");
    }, Ca = () => Date.now(), La = (e, a, t) => H.copyWithin(e, a, a + t), Oa = (e) => {
      L("OOM");
    }, ja = (e) => {
      H.length, Oa();
    }, be = {}, Ua = () => ae || "./this.program", Z = () => {
      if (!Z.strings) {
        ...
        for (var t in be)
          be[t] === void 0 ? delete a[t] : a[t] = be[t];
        var r = [];
        for (var t in a)
          r.push(`${t}=${a[t]}`);
        Z.strings = r;
      ...
      return Z().forEach((r, s) => {
        var i = a + t;
        A[e + s * 4 >> 2] = i, Ba(r, i), t += r.length + 1;
      }), 0;
    }, Ha = (e, a) => {
      var t = Z();
      A[e >> 2] = t.length;
    ...
    var Ga = (e, a, t, r) => {
      for (var s = 0, i = 0; i < t; i++) {
        var o = A[a >> 2], l = A[a + 4 >> 2];
        a += 8;
        var m = n.read(e, T, o, l, r);
        if (m < 0) return -1;
        if (s += m, m < l) break;
      }
      return s;
    ...
    function $a(e, a, t, r) {
      try {
        var s = F.getStreamFromFD(e), i = Ga(s, a, t);
        return A[r >> 2] = i, 0;
      } catch (o) {
    ...
    var Xa = (e, a) => a + 2097152 >>> 0 < 4194305 - !!e ? (e >>> 0) + a * 4294967296 : NaN;
    function Va(e, a, t, r, s) {
      var i = Xa(a, t);
      try {
        if (isNaN(i)) return 61;
        var o = F.getStreamFromFD(e);
        return n.llseek(o, i, r), M = [
          o.position >>> 0,
          (u = o.position, +Math.abs(u) >= 1 ? u > 0 ? +Math.floor(u / 4294967296) >>> 0 : ~~+Math.ceil((u - +(~~u >>> 0)) / 4294967296) >>> 0 : 0)
        ], k[s >> 2] = M[0], k[s + 4 >> 2] = M[1], o.getdents && i === 0 && r === 0 && (o.getdents = null), 0;
      } catch (l) {
        if (typeof n > "u" || l.name !== "ErrnoError") throw l;
        return l.errno;
      }
    ...
    function Ja(e, a, t, r) {
      try {
        var s = F.getStreamFromFD(e), i = Ka(s, a, t);
        return A[r >> 2] = i, 0;
      } catch (o) {
        if (typeof n > "u" || o.name !== "ErrnoError") throw o;
        return o.errno;
    ...
    var fe = (e) => e % 4 === 0 && (e % 100 !== 0 || e % 400 === 0), Za = (e, a) => {
      for (var t = 0, r = 0; r <= a; t += e[r++])
        ;
      return t;
    }, Ie = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], Ye = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], Qa = (e, a) => {
      ...
      for (var m in l)
        o = o.replace(new RegExp(m, "g"), l[m]);
      ...
      function E(f) {
        var c = Qa(new Date(f.tm_year + 1900, 0, 1), f.tm_yday), z = new Date(c.getFullYear(), 0, 4), D = new Date(c.getFullYear() + 1, 0, 4), x = _(z), R = _(D);
...
`,
      ...
      o = o.replace(/%%/g, "\0\0");
      for (var m in b)
        o.includes(m) && (o = o.replace(new RegExp(m, "g"), b[m](i)));
      o = o.replace(/\0\0/g, "%");
      var S = le(o, !1);
      return S.length > a ? 0 : (et(S, e), S.length - 1);
    }, tt = (e, a, t, r, s) => at(e, a, t, r), nt = (e) => {
    ...
    }), n.FSNode = We, n.createPreloadedFile = Ea, n.staticInit(), d.FS_createPath = n.createPath, d.FS_createDataFile = n.createDataFile, d.FS_createPreloadedFile = n.createPreloadedFile, d.FS_unlink = n.unlink, d.FS_createLazyFile = n.createLazyFile, d.FS_createDevice = n.createDevice;
    var st = {
      a: pa,
      b: ua,
      e: Fa,
      ...
      i: Ja,
      m: tt
    }, j = ca(), Ge = d._main = (e, a) => (Ge = d._main = j.y)(e, a), $e = () => ($e = j.z)(), Ee = (e) => (Ee = j.B)(e), Xe = (e) => (Xe = j.C)(e);
    d.addRunDependency = ie, d.removeRunDependency = J, d.FS_createPath = n.createPath, d.FS_createLazyFile = n.createLazyFile, d.FS_createDevice = n.createDevice, d.callMain = Ve, d.FS_createPreloadedFile = n.createPreloadedFile, d.FS = n, d.FS_createDataFile = n.createDataFile, d.FS_unlink = n.unlink;
    var pe;
    K = function e() {
      pe || Ke(), pe || (K = e);
    };
    ...
    function Ke(e = ge) {
      if (U > 0 || (ta(), U > 0))
        return;
      function a() {
        pe || (pe = !0, d.calledRun = !0, !Me && (na(), ra(), Fe(d), d.onRuntimeInitialized && d.onRuntimeInitialized(), Je && Ve(e), sa()));
      }
    ...
    if (d.preInit)
      for (typeof d.preInit == "function" && (d.preInit = [d.preInit]); d.preInit.length > 0; )
        d.preInit.pop()();
    var Je = !1;
    return d.noInitialRun && (Je = !1), Ke(), Se.ready;
  };
})();
export {
  ot as createPiperPhonemize
};
